export default function Hero() {
  return (
    <section className="relative min-h-screen bg-portfolio-cream flex items-center justify-center px-4 pt-24">
      ...
      <div className="relative max-w-6xl mx-auto text-center">
        ...
        <div className="space-y-4 mb-8">
          <h1 className="text-5xl md:text-6xl lg:text-7xl font-serif font-normal text-portfolio-text-primary leading-tight tracking-tight">
        ...
        {/* Subtitle */}
        <p className="text-lg md:text-xl text-portfolio-text-secondary max-w-2xl mx-auto mb-8 leading-relaxed">
          Transform your ideas into beautiful, functional products with expert development and design services.
        </p>

        {/* CTA Section */}
        <div className="flex flex-col items-center space-y-6">
          <button className="inline-flex items-center bg-black text-white px-8 py-4 rounded-2xl text-lg font-medium shadow-lg hover:shadow-xl transition-all duration-200 group">
